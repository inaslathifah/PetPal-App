...
const Payment: FC = () => {
    ...
    const handlePayment = (e: React.FormEvent) => {
        ...
        Swal.fire({
            ...
            if (res.isConfirmed) {
                axios.post("/api/payment", pembayaran).then((response) => {
        ...
        <Layout>
            ...
            <form onSubmit={handlePayment} className="flex justify-center items-center gap-3 h-auto my-20">
                <div className="flex flex-col justify-center gap-3 w-full md:w-1/2">
                    ...
                    <Button type="submit" className="flex justify-center items-center mt-10 font-semibold bg-sky-600 w-full text-white py-2.5 rounded-md">Lanjutkan Pembayaran</Button>
                </div>
            </form>
